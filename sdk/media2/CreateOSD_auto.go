...
func Call_CreateOSD(ctx context.Context, dev *onvif.Device, request media2.CreateOSD) (media2.CreateOSDResponse, error) {
	type Envelope struct {
		Header struct{}
		Body   struct {
			CreateOSDResponse media2.CreateOSDResponse
		}
	}
	var reply Envelope
